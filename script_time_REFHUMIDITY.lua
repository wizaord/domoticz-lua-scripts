...
if ( currentDate.hour == 5 and currentDate.min == 10 )
then
	...
	if (sdbHumidity == nil or sdbHumidity == '') then
		commandArray['SendEmail']='[DOMOTICZ] HUMIDITY REF#Erreur de recuperation. Set default value a 50#mouilleron.cedric@gmail.com'
		sdbHumidity = 50
	end
